...
//    public static final int phoneImeiLen = 16;
    ...
    public static String CAMERA_LAT = "";
    public static String CAMERA_LNG = "";
    public static String BEARING = "";//方向角
    public static String GPS_STATES = "";//jps状态
    public static String ALTITUDE = "";//海拔
}
