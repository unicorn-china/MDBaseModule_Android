...
public class CityPickerView implements CanShow, OnWheelChangedListener {
    ...
    public interface OnCityItemClickListener {
         ...
         * @param district
         */
        void onSelected(NewProvinceBean province, NewCityBean city, NewDistrictBean district);
...
//        }
    ...
    private void setUpData() {
        ...
        ArrayWheelAdapter arrayWheelAdapter = new ArrayWheelAdapter<NewProvinceBean>(config.getContext(),
    ...
    private void updateCities() {
        ...
        //省份选中的名称
        NewProvinceBean mProvinceBean = parseHelper.getProvinceBeenArray()[pCurrent];
        ...
        NewCityBean[] cities = parseHelper.getPro_CityMap().get(mProvinceBean.getName());
        if (cities == null) {
            return;
        }
        ...
        ArrayWheelAdapter cityWheel = new ArrayWheelAdapter<NewCityBean>(config.getContext(), cities);
        // 设置可见条目数量
    ...
    private void updateAreas() {
        ...
        NewCityBean mCityBean = parseHelper.getPro_CityMap().get(parseHelper.getProvinceBean().getName())[pCurrent];
        if (mCityBean == null) {
            parseHelper.setCityBean(null);
        } else {
            parseHelper.setCityBean(mCityBean);
        }

        NewDistrictBean[] areas = parseHelper.getCity_DisMap()
        ...
        ArrayWheelAdapter districtWheel = new ArrayWheelAdapter<NewDistrictBean>(config.getContext(), areas);
        // 设置可见条目数量
        ...
        NewDistrictBean mDistrictBean = null;
    ...
    public void onChanged(WheelView wheel, int oldValue, int newValue) {
        if (wheel == mViewProvince) {
            ...
            if (parseHelper != null && parseHelper.getCity_DisMap() != null) {
                NewDistrictBean mDistrictBean = parseHelper.getCity_DisMap()
